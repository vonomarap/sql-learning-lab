...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 11, 2022 at 10:18 PM
...
--
-- Structure for view `7_1` exported as a table
--
DROP TABLE IF EXISTS `7_1`;
CREATE TABLE`7_1`(
    `specialization` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Список специализаций',
    `Количество работников` bigint(22) NOT NULL DEFAULT '0'
);

-- --------------------------------------------------------

--
-- Structure for view `7_2` exported as a table
--
DROP TABLE IF EXISTS `7_2`;
CREATE TABLE`7_2`(
    `customer_id` int(8) DEFAULT '0' COMMENT 'Уникальный идентификатор заказчика',
    `fio_contact_person` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT ' ФИО контактного лица заказчика',
    `employee_id` int(8) NOT NULL DEFAULT '0' COMMENT 'Уникальный идентификатор сотрудника',
    `first_name` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Имя сотрудника',
    `last_name` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Фамилия сотрудника',
    `surname` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Отчество сотрудника',
    `order_id` int(8) DEFAULT '0' COMMENT 'Уникальный идентификатор заказа',
    `order_name` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Название заказа'
);

-- --------------------------------------------------------

--
-- Structure for view `7_3` exported as a table
--
DROP TABLE IF EXISTS `7_3`;
CREATE TABLE`7_3`(
    `category` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Категория заказа',
    `Количество заказов` bigint(21) DEFAULT NULL,
    `start_date` date DEFAULT NULL COMMENT 'Дата поступления заказа'
);

-- --------------------------------------------------------

--
-- Structure for view `7_4` exported as a table
--
...
CREATE TABLE`7_4`(
    ...
    `order_id` int(8) DEFAULT '0' COMMENT 'Уникальный идентификатор заказа',
    `order_name` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Название заказа',
    `max_work_time` int(11) DEFAULT NULL COMMENT 'Длительность выполнения заказа в часах'
);

-- --------------------------------------------------------

--
-- Structure for view `7_5` exported as a table
--
DROP TABLE IF EXISTS `7_5`;
CREATE TABLE`7_5`(
    `specialization` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Список специализаций',
    `num_order` bigint(21) NOT NULL DEFAULT '0'
);
